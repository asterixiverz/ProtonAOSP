...
@SearchIndexable
public class SettingsSpoof extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {

    public static final String TAG = "SettingsSpoof";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUpdateJsonButton.setOnPreferenceClickListener(preference -> {
            updatePropertiesFromUrl("https://raw.githubusercontent.com/crdroidandroid/android_vendor_certification/refs/heads/15.0/gms_certified_props.json");
            return true;
        });
